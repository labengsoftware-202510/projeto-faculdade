...
import Page.Page_Matriculas_Cursos_R as Pg_R   #script da página de listagem da tabelas genéricas
import Controllers.listas as lst


#parametros da pagina ao mostrar no browser
st.set_page_config(page_title= 'Matriculas - Cursos', 
                layout= 'wide',
                initial_sidebar_state= 'collapsed')

#titulo da página
st.title('Matriculas - Cursos')
